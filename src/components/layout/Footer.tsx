...
const Footer = () => {
  return (
    <footer id="contact" className="bg-black-primary text-text-light py-10 border-t border-dark-gray-bg/50">
      <div className="container mx-auto px-4 md:px-6 grid grid-cols-1 md:grid-cols-3 gap-8 text-center md:text-left">
        ...
        <div className="flex flex-col items-center md:items-start">
          ...
          <ul className="space-y-2">
            ...
            <li><a href="#about" className="text-sm text-muted-foreground hover:text-neon-blue transition-colors">About</a></li>
          </ul>
        </div>
      </div>
    </footer>
