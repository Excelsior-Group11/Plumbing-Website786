...
import { MessageCircle, Wrench } from "lucide-react"; // Import Wrench icon
    ...
    <section className="bg-gradient-to-r from-blue-primary to-navy-deep text-white py-16 md:py-20 text-center shadow-inner">
      <div className="container mx-auto px-4 md:px-6 animate-fade-in-up">
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-4">
          ...
          <Button asChild size="lg" className="bg-white hover:bg-gray-100 text-green-500 font-bold text-lg px-8 py-6 rounded-full shadow-lg hover:scale-105 hover:shadow-xl transition-all duration-300">
            <a href="https://wa.me/27795174640" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2">
