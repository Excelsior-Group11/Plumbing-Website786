...
const ProcessSection = () => {
  ...
  return (
    <section id="process" className="py-16 md:py-24 bg-dark-gray-bg text-text-light">
      <div className="container mx-auto px-4 md:px-6 text-center">
        ...
        <div className="relative flex flex-col md:flex-row justify-between items-center gap-8 md:gap-4">
          ...
          <div className="hidden md:block absolute top-1/2 left-0 right-0 h-0.5 bg-gradient-to-r from-neon-blue to-neon-purple opacity-50 z-0"></div>
          {/* Vertical line for mobile */}
          <div className="md:hidden absolute left-1/2 top-0 bottom-0 w-0.5 bg-gradient-to-b from-neon-blue to-neon-purple opacity-50 z-0 transform -translate-x-1/2"></div>

          {steps.map((step, index) => (
            <div
              key={index}
              className="relative z-10 flex flex-col items-center text-center p-6 bg-black-primary/70 border border-neon-blue/30 rounded-xl shadow-lg
